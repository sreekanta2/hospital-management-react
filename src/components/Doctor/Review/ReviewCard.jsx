...
export default function ReviewCard() {
  return (
    <div className="  w-full px-6 lg:px-8 border-b rounded-md p-6 ">
      <div className="">
        <div className="flex flex-col md:flex-row md:justify-between">
          <div
            scope="row"
            className="  py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white flex md:flex-col lg:flex-row gap-4 items-center"
          >
        ...
        <div className="flex justify-end mr-4 gap-4">
          ...
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
            <span className="relative px-4   transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
              Yes
            </span>
          </button>
