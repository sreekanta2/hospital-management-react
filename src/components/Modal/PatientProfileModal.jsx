export default function PatientProfileModal({ open, control }) {
  return (
    open && (
      <>
        <div
        ...
        ></div>
        <div className="rounded w-[400px]  space-y-8 bg-white p-6 absolute top-1/2 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2">
